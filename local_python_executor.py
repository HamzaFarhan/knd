...
class LocalPythonExecutor(PythonExecutor):
    def __init__(self, additional_authorized_imports: list[str], max_print_outputs_length: int | None = None):
        self.custom_tools = {}
        self.state = {}
    ...
    def __call__(self, code_action: str) -> tuple[Any, str, bool]:
        code_action = fix_final_answer_code(parse_code_blobs(code_action))
...
def python_code_executor_tool(code: str) -> Any:
    ...
    executor.send_tools(tools={"final_answer": final_answer})
